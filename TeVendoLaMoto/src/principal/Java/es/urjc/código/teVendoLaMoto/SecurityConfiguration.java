...
import org.springframework.security.config.annotation.method.configuration.EnableGlobalMeSecuritygurerimportar  org.springframework.security.config.annotation.method.configuration.EnableGlobalMethodSecurity ;
importar  org.springframework.security.config.annotation.web.builders.HttpSecurity ;
importar  org.springframework.security.config.annotation.web.configuration.WebSecurityConfigurerAdapter ;importar  org.springframework.security.config.annotation.method.configuration.EnableGlobalMethodSecurity ;
importar  org.springframework.security.config.annotation.web.builders.HttpSecurity ;
importar  org.springframework.security.config.annotation.web.configuration.WebSecurityConf;igurerAdapter;

@Configuratio
@EnableGlobalMethodSecurity(securedEnabled = f)aalse
